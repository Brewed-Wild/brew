      ...
      <div className="col-sm-10 mx-auto">
        ...
        <div className="endResultContainer col-sm-12 text-justify p-5 ml-5 my-5">
          ...
          <p className="mb-4">
            ...
            at the end of an evening - we've got you covered. Read on to discover some of the beers that await,
            or book a brewery tour to see where the magic happens.
          </p>
          <img
        ...
        <button
          className="btn-lg btn-info my-5"
          onClick={redirect}
        >
          EXPLORE OUR RECIPES
        </button>
