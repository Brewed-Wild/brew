    ...
    return (
      <footer className="d-grid bg-light h-100" id="footerContainer">
        <div className="row d-flex align-items-center justify-content-between flex-md-row">
          ...
          <div
            className=" col d-flex flex-column flex-md-row justify-content-start justify-content-md-center"
            id="social-icons"
          >
            <a href="http://www.twitter.com">
              <img src={Twitter} alt="" className="social-icon m-3" />
            </a>
            <a href="http://www.facebook.com">
              <img src={Facebook} alt="" className="social-icon m-3" />
            </a>
            <a href="http://www.instagram.com">
              <img src={Instagram} alt="" className="social-icon m-3" />
            </a>
          </div>
          <div
            ...
            <p>
              ...
              <div className="partner-logo-container d-inline-grid justify-self-center">
                <a href="https://www.raspberrypi.org/">
                  <img className="easytech-logo" src={Easytech} alt="" />
                </a>
                <a href="https://handyman.com/">
                  <img className="fixee-logo" src={Fixee} alt="" />
                </a>
          ...
          >
            <p className="text-right mr-4">
              ...
              <p>
                <a
                  href="mailto:hi@brewersheaven.com"
                  target="_blank"
                ...
                <br />
                <a
                  href="https://www.google.com/maps/place/Rua+do+Conde+de+Redondo+145,+1150-294+Lisboa/@38.7248464,-9.1481597,17z/data=!3m1!4b1!4m5!3m4!1s0xd193377dbff9c5d:0xeb7c8841e775e3ae!8m2!3d38.7248464!4d-9.145971"
                  className="text-dark"
                >
